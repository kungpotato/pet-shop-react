...
export type ContractContext = Web3ContractContext<NFT, NFTMethodNames, NFTEventsContext, NFTEvents>
export type NFTEvents = 'Approval' | 'ApprovalForAll' | 'Transfer'
...
export interface NFT {
   ...
   * Type: constructor
   * @param marketplaceAddress Type: address, Indexed: false
   */
  'new'(marketplaceAddress: string): MethodReturnContext
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   ...
   */
  mintToken(tokenURI: string): MethodReturnContext
}
